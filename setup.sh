...
sudo apt-get install --yes --force-yes unzip mitmproxy python python-pip python2.7-dev python-pyasn1 libxml2-dev libxslt1-dev python-setuptools python-mysqldb screen libxss-dev xvfb chromium-browser
